        ...
        mBinding.register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (formValid()) {
                    ...
                    Intent intent = getPackageManager().getLaunchIntentForPackage("com.tabpilot");
                    boolean litLabUser = intent != null;
                    ...
                    mSubscription = RemoteRepo.register(RegistrationActivity.this,
                            Mapper.toRegisterParams(firstName, lastName, zip, phone,
                                    ...
                                    schoolName, schoolDistrict, teacherName, mTimeString,
                                    registerTime, gender, litLabUser))
